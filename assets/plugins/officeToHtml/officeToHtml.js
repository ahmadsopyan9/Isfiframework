...
(function ($) {
    ...
    function getPdfContent(fObj, divId, pdfSet) {
        ...
        var full_path = (typeof base_url != "undefined") ? base_url : location.href;
    ...
    */
    ...
    function getImgContent(fObj, divId, imgSet) {
        ...
        const img_container = $(".jqvsiv_main_image_content img.image_container");
        img_container[0].removeAttribute("width");
        img_container[0].removeAttribute("height");
        img_container[0].style.removeProperty = "position";
        img_container[0].style.margin = "25px auto !important";
        setTimeout(function(){
            img_container[0].style.position = "relative";
            img_container[0].style.width = "700px !important";
            img_container[0].style.height = "700px !important";
            img_container[0].style.cursor = "auto";
            img_container[0].style.display = "table";
            img_container[0].style.verticalAlign = "middle";
            img_container[0].setAttribute("width", "500");
            img_container[0].setAttribute("height", "500");
            img_container[0].style.margin = "25px auto";
        }, 500);
        return true;
    }
    /////////////////////////////////////////////////Unknown file//////////////////////////////////////////
